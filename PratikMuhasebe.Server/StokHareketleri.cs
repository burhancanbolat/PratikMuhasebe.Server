...
public partial class StokHareketleri
{
    ...
    public string? SthHareketGrupKodu1 { get; set; }

    public string? SthHareketGrupKodu2 { get; set; }

    public string? SthHareketGrupKodu3 { get; set; }

    public double? SthOlcu1 { get; set; }

    public double? SthOlcu2 { get; set; }

    public double? SthOlcu3 { get; set; }

    public double? SthOlcu4 { get; set; }

    public double? SthOlcu5 { get; set; }

    public byte? SthFormulMiktarNo { get; set; }

    public double? SthFormulMiktar { get; set; }

    public byte? SthEirsSenaryo { get; set; }

    public byte? SthEirsTipi { get; set; }

    public DateTime? SthTeslimTarihi { get; set; }

    public bool? SthMatbuFl { get; set; }

    public byte? SthSatisFiyatDovizCinsi { get; set; }

    public double? SthSatisFiyatDovizKuru { get; set; }

    public string? SthEticaretKanalKodu { get; set; }
}
