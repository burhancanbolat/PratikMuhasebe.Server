...
public partial class UfrsFisleri
{
    ...
    public byte? FisTicariEvrakcins { get; set; }
    ...
    public int? FisSozTaksitno { get; set; }
    ...
    public byte? FisUfrsKayittipi { get; set; }

    public double? FisVukMeblag0 { get; set; }

    public double? FisVukMeblag1 { get; set; }

    public double? FisVukMeblag2 { get; set; }

    public double? FisVukMeblag3 { get; set; }

    public double? FisVukMeblag4 { get; set; }

    public double? FisVukMeblag5 { get; set; }

    public double? FisVukMeblag6 { get; set; }
