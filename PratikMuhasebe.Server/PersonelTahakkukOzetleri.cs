...
public partial class PersonelTahakkukOzetleri
{
    ...
    public double? ProKidemtazminati { get; set; }

    public double? ProIhbartazminati { get; set; }

    public double? ProDevirdigsigortaIsverenEscocuk { get; set; }

    public double? ProDigersigIsverenEscocuk1 { get; set; }

    public double? ProDigersigIsverenEscocuk2 { get; set; }

    public double? ProDigersigIsverenEscocuk3 { get; set; }

    public double? ProDigersigIsverenEscocuk4 { get; set; }

    public double? ProDigersigIsverenEscocuk5 { get; set; }

    public double? ProDigersigIsverenEscocuk6 { get; set; }

    public double? ProDigersigIsverenEscocuk7 { get; set; }

    public double? ProDigersigIsverenEscocuk8 { get; set; }

    public double? ProDigersigIsverenEscocuk9 { get; set; }

    public double? ProDigersigIsverenEscocuk10 { get; set; }

    public double? ProDigersigIsverenEscocuk11 { get; set; }

    public double? ProDigersigIsverenEscocuk12 { get; set; }

    public double? ProHayatsigIsverenIndoran { get; set; }

    public double? ProHayatsigCalisanIndoran { get; set; }

    public double? ProGecyilDevirSaatlikizin { get; set; }

    public byte? ProDevredenSskHangiKanun1 { get; set; }

    public byte? ProDevredenSskHangiKanun2 { get; set; }

    public byte? ProDevredenSskHangiKanun3 { get; set; }

    public byte? ProDevredenSskHangiKanun4 { get; set; }

    public byte? ProDevredenSskHangiKanun5 { get; set; }

    public byte? ProDevredenSskHangiKanun6 { get; set; }

    public byte? ProDevredenSskHangiKanun7 { get; set; }

    public byte? ProDevredenSskHangiKanun8 { get; set; }

    public byte? ProDevredenSskHangiKanun9 { get; set; }

    public byte? ProDevredenSskHangiKanun10 { get; set; }

    public byte? ProDevredenSskHangiKanun11 { get; set; }

    public byte? ProDevredenSskHangiKanun12 { get; set; }
}
